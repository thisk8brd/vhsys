...
function Header() {
  ...
  const [stick, changeStick] = useState(false);
      ...
      <header className="header">
        <div className="container header__container">
          <nav className="header__nav">
            ...
            <ul className={`header__navbar navbar${headerActive ? ' active' : ''}`}>
              <button className="btn btn--close" onClick={() => showHeader(false)}>
                <svg className="icon icon--close" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21.9 21.9">
              ...
              <li className="navbar__item">
                <button className="btn btn--primary" onClick={() => console.log('Call')}>
                  Nós Ligamos
              </button>
              </li>
            </ul>
            <div className="header__menu menu" onClick={() => showHeader(!headerActive)}>
              <svg className="icon icon--menu" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 396.667 396.667">
