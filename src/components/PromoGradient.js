    ...
    <section className="promo--gradient">
      <div className="container promo--gradient__container">
        ...
        <div className="promo--gradient__content">
          <p className='promo--gradient__text'>Faça como <strong>mais de 150 mil</strong> pequenas e médias empresas e experimente o Sistema de Gestão Online Gratuito por 7 dias!</p>
